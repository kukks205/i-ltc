...
d.suicide_score,d.no_depression,d.hospcode
from
depression_screen AS d
join vn_stat as v on d.vn = v.vn and d.hospcode = v.hospcode
join person as p on p.patient_hn=v.hn and p.hospcode=v.hospcode
